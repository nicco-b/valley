...
// hard at authored water cells (the pond and rivers are this field's
// sinks — their own water is Hydrology's, tier 1). Also writes the
// display texture the water sheet samples: R = depth, G = flow speed.
...
layout(push_constant) uniform Push {
	int grid; float rain; float soak; float sink_keep; float seep;
} pc;
